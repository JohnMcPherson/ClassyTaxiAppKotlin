...
package nz.co.afleet.taxisubscription

import android.app.Application
import nz.co.afleet.taxisubscription.Constants.Companion.USE_FAKE_SERVER
import nz.co.afleet.taxisubscription.billing.BillingClientLifecycle
import nz.co.afleet.taxisubscription.data.DataRepository
import nz.co.afleet.taxisubscription.data.disk.LocalDataSource
import nz.co.afleet.taxisubscription.data.disk.db.AppDatabase
import nz.co.afleet.taxisubscription.data.network.WebDataSource
import nz.co.afleet.taxisubscription.data.network.firebase.FakeServerFunctions
import nz.co.afleet.taxisubscription.data.network.firebase.ServerFunctions
